...
<div style="margin:50px">
    <div>
        ...
        <!-- Form -->
        <form method='post' id="exim_import_form" action='<?php echo $_SERVER['REQUEST_URI']; ?>' enctype='multipart/form-data'>
            </br>
            <label for="taxonomy_name">Taxonomy Name</Label></br>
            <select name="taxonomy_name" id="taxonomy_name">
                <option value="at_biz_dir-location" selected>Location</option>
                <option value="at_biz_dir-category">Category</option>
            </select>
            </br>
            </br>
            ...
            <input type="hidden" id="exim_nonce" value=<?php echo wp_create_nonce("exim_import_nonce"); ?>>
